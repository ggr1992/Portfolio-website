...
const About = () => {
  return (
    ...
    <p>
    Throughout the bootcamp, I immersed myself in different programming languages and technologies, with a primary focus on JavaScript. I took on both front-end and back-end projects I enjoy problem solving that tackling these projects helped me improve my problem solving ability.
    </p>
    <p>
    One highlight of of the bootcamp test-driven development (TDD). This approach not only refined my coding skills but helped me to be disciplined and methodical when it comes to creating software.
    </p>
