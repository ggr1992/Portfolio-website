...
import groupVideo from '../../assets/Videos/PowerPoint Slide Show  -  Presentation1.pptx 2023-06-23 11-38-30.mp4'
  ...
  const moreInfoArray = [
    {
      ...
      media: groupVideo,
      description:
        "This is my groups video showcase displaying our app",
    }
  ];
